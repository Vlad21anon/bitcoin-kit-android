...
import io.dexnet.bitcoincore.blocks.validators.BitsValidator
...
import io.dexnet.bitcoincore.blocks.validators.LegacyTestNetDifficultyValidator
import io.dexnet.bitcoincore.core.purpose
import io.dexnet.bitcoincore.managers.ApiSyncStateManager
import io.dexnet.bitcoincore.managers.Bip44RestoreKeyConverter
import io.dexnet.bitcoincore.managers.Bip49RestoreKeyConverter
import io.dexnet.bitcoincore.managers.BlockValidatorHelper
import io.dexnet.bitcoincore.managers.KeyHashRestoreKeyConverter
...
import io.dexnet.bitcoincore.utils.SegwitAddressConverter
import io.horizontalsystems.hdwalletkit.HDExtendedKey
import io.horizontalsystems.hdwalletkit.HDWallet.Purpose
import io.horizontalsystems.hdwalletkit.Mnemonic
import io.dexnet.litecoinkit.validators.LegacyDifficultyAdjustmentValidator
import io.dexnet.litecoinkit.validators.ProofOfWorkValidator
...
class LitecoinKit : AbstractKit {
    ...
    private fun bitcoinCore(
        ...
        val database = io.dexnet.bitcoincore.storage.CoreDatabase.getInstance(context, getDatabaseName(networkType, walletId, syncMode, purpose))
    ...
    private fun apiTransactionProvider(
        ...
        NetworkType.MainNet -> {
            val bCoinApiProvider =
                io.dexnet.bitcoincore.apisync.BCoinApi("https://ltc.blocksdecoded.com/api")
        ...
        NetworkType.TestNet -> {
            io.dexnet.bitcoincore.apisync.BCoinApi("")
        }
    }
