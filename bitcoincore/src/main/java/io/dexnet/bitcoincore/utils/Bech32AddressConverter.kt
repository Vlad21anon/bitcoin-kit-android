package io.dexnet.bitcoincore.utils

import io.dexnet.bitcoincore.crypto.Bech32.Encoding
import io.dexnet.bitcoincore.crypto.Bech32Cash
import io.dexnet.bitcoincore.crypto.Bech32Segwit
        ...
        return when (val version = data[0].toInt()) {
            0 -> {
                val type = when (program.size) {
                    ...
                    else -> throw AddressFormatException(
