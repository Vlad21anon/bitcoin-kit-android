package io.dexnet.bitcoincash

import android.content.Context
import android.database.sqlite.SQLiteDatabase
import io.dexnet.bitcoincash.blocks.BitcoinCashBlockValidatorHelper
import io.dexnet.bitcoincash.blocks.validators.AsertValidator
import io.dexnet.bitcoincash.blocks.validators.DAAValidator
import io.dexnet.bitcoincash.blocks.validators.EDAValidator
import io.dexnet.bitcoincash.blocks.validators.ForkValidator
...
import io.dexnet.bitcoincore.apisync.BlockHashFetcher
import io.dexnet.bitcoincore.apisync.BlockchainComApi
import io.dexnet.bitcoincore.apisync.HsBlockHashFetcher
...
import io.dexnet.bitcoincore.blocks.validators.LegacyDifficultyAdjustmentValidator
...
import io.dexnet.bitcoincore.managers.BlockchairCashRestoreKeyConverter
...
import io.dexnet.bitcoincore.utils.CashAddressConverter
...
class BitcoinCashKit : AbstractKit {
    ...
    private fun bitcoinCore(
        ...
        val database = io.dexnet.bitcoincore.storage.CoreDatabase.getInstance(context, getDatabaseName(networkType, walletId, syncMode))
